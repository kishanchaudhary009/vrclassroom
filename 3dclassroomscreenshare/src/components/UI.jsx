...
export const UI = ({ hidden,isTeacher, setIsTeacher, ...props }) => {
  const input = useRef();
    ...
    <>
      <div className="fixed top-0 left-0 right-0 bottom-0 z-10 flex justify-between p-4 flex-col pointer-events-none">
        <div className="self-start backdrop-blur-md bg-white bg-opacity-50 p-4 rounded-lg">
          <h1 className="font-black text-xl">My Virtual AI Teacher</h1>
          <p>Welcome to Doubt Session</p>
        </div>
        <div className="w-full flex flex-col items-end justify-center gap-4">
          {/* Add a new button for toggling between Teacher and Student modes */}
          <button
        ...
        <div className="flex items-center gap-2 pointer-events-auto max-w-screen-sm w-full mx-auto">
          <input
            ...
            ref={input}
            onKeyDown={(e) => {
              if (e.key === "Enter" && !loading && !message) {
                sendMessage();
              }
            }}
          />
