...
export function New_classroom(props) {
  const { nodes, materials } = useGLTF("/models/classroom.glb");
  const boardTexture = useTexture("/images/car.jpg");
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes['Collection|board_L_boardblend|Dupli|_board_0'].geometry}
        position={[-31.238, 78.386, 502.521]}
        rotation={[-Math.PI / 2, 0, 0]}
        scale={100}
      >
        {/* Replace the material with a custom material using the loaded texture */}
      ...
      >
        ...
        <mesh
          ...
          receiveShadow
          geometry={
            nodes["Window002|Window_L_Windowblend|Dupli|1_PlasticGrey_0"]
              .geometry
          }
      ...
      >
        <mesh
          ...
          receiveShadow
          geometry={
            nodes["Window003|Wall_L_Windowblend|Dupli|_wallConcrete_0"].geometry
          }
          material={materials.wallConcrete_0}
        />
        <mesh
          ...
          receiveShadow
          geometry={
            nodes["Window003|Window_L_Windowblend|Dupli|1_PlasticGrey_0"]
              .geometry
          }
          material={materials.PlasticGrey}
        />
        <mesh
          ...
          receiveShadow
          geometry={
            nodes["Window003|Glass_L_Windowblend|Dupli|2_glass_0"].geometry
          }
          material={materials.glass}
        />
        <mesh
          ...
          geometry={
            nodes[
              "Window003|WindowWoodPlate_L_Windowblend|Dupli|3_WindowWoodPlate_0"
            ].geometry
          }
          material={materials.WindowWoodPlate}
          position={[-0.118, 0.862, -0.761]}
        ...
        <mesh
          ...
          receiveShadow
          geometry={
            nodes["Window003|Plane_L_Windowblend|Dupli|4_Rideau_0"].geometry
          }
          material={materials.Rideau}
          position={[0.019, 1.129, 1.127]}
          rotation={[0, Math.PI / 2, 0]}
      ...
      <mesh
        ...
        receiveShadow
        geometry={
          nodes["casiers_low001|casiers_L_casiersblend|Dupli|_casiers_0"]
            .geometry
        }
        material={materials.casiers}
      ...
      <mesh
        ...
        receiveShadow
        geometry={
          nodes["casiers_low002|casiers_L_casiersblend|Dupli|_casiers_0"]
            .geometry
        }
        material={materials.casiers}
      ...
      <mesh
        ...
        receiveShadow
        geometry={
          nodes["casiers_low003|casiers_L_casiersblend|Dupli|_casiers_0"]
            .geometry
        }
        material={materials.casiers}
      ...
      <mesh
        ...
        receiveShadow
        geometry={
          nodes["casiers_low004|casiers_L_casiersblend|Dupli|_casiers_0"]
            .geometry
        }
        material={materials.casiers}
      ...
      <mesh
        ...
        receiveShadow
        geometry={
          nodes["casiers_low005|casiers_L_casiersblend|Dupli|_casiers_0"]
            .geometry
        }
        material={materials.casiers}
      ...
      <group
        position={[154.089, 340.215, 247.976]}
        rotation={[-Math.PI / 2, 0, 0]}
        scale={100}
      >
        <mesh
      ...
      >
        ...
        <mesh
          ...
          receiveShadow
          geometry={
            nodes["Door001|handle_L_doorblend|Dupli|1_Chrome_0"].geometry
          }
      ...
      <group
        position={[377.215, 44.441, -299.108]}
        rotation={[-Math.PI / 2, 0, 0]}
        scale={100}
      >
        <mesh
      ...
      <group
        position={[377.215, 44.441, 314.355]}
        rotation={[-Math.PI / 2, 0, 0]}
        scale={100}
      >
        <mesh
          ...
          geometry={
            nodes[
              "radiateur001|radiateur001_L_radiateurblend|Dupli|_radiateur_0"
            ].geometry
          }
          material={materials.radiateur}
        />
        <mesh
          ...
          receiveShadow
          geometry={
            nodes["radiateur001|radiateur_L_radiateurblend|Dupli|1_radiateur_0"]
              .geometry
          }
          material={materials.radiateur}
        />
      ...
      >
        ...
        <mesh
          ...
          receiveShadow
          geometry={
            nodes["etagere001|etagere001_L_etagereblend|Dupli|1_etagere_0"]
              .geometry
          }
          material={materials.etagere}
        />
      ...
      >
        ...
        <mesh
          ...
          geometry={
            nodes[
              "porteManteau|porteManteau002_L_porteManteaublend|Dupli|1_Chrome_0"
            ].geometry
          }
        ...
        <mesh
          ...
          geometry={
            nodes[
              "porteManteau|porteManteau001_L_porteManteaublend|Dupli|2_Chrome_0"
            ].geometry
          }
          material={materials.Chrome_0}
