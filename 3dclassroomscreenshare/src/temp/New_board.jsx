...
export function New_board(props) {
  const { nodes, materials } = useGLTF('models/New_board_Classroom_Updated.glb')
  const [boardTexture, setBoardTexture] = useState(null)

  const texture = useTexture('/images/image.jpg', (texture) => {
    texture.flipY = false; // Flip the texture if needed
  ...
  // useEffect(() => {
  //   if (boardTexture) {
  //     const boardWidth = 19.3; // Width of the board in meters
  //     const boardHeight = 6.62; // Height of the board in meters
  //     const boardAspectRatio = boardWidth / boardHeight;

  //     const imageAspectRatio = boardTexture.image.width / boardTexture.image.height;

  //     if (imageAspectRatio > boardAspectRatio) {
  //       // Image is wider than the board
  //       boardTexture.repeat.set(imageAspectRatio / boardAspectRatio, 1);
  //       boardTexture.offset.set(-((imageAspectRatio / boardAspectRatio) - 1) / 2, 0);
  //     } else {
  //       // Image is taller than the board
  //       boardTexture.repeat.set(1, boardAspectRatio / imageAspectRatio);
  //       boardTexture.offset.set(0, -((boardAspectRatio / imageAspectRatio) - 1) / 2);
  //     }

  //     boardTexture.needsUpdate = true;
  //     console.log('Board Aspect Ratio:', boardAspectRatio);
...
useGLTF.preload('models/New_board_Classroom_Updated.glb')