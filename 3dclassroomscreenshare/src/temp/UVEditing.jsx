...
export function UVEditing(props) {
  const { nodes, materials } = useGLTF('/models/classroom_updated2.glb');
  const boardTexture =useTexture('/images/image.jpg');
      ...
      <group rotation={[-Math.PI / 2, 0, 0]} scale={0.052}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          ...
          <mesh
            ...
            scale={100}
          />
          <group position={[-31.238, 78.386, 502.522]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
            <mesh
              castShadow
              receiveShadow
              geometry={nodes['Collection|board_L_boardblend|Dupli|_board_0_1'].geometry}
              
            >
              <meshStandardMaterial map={boardTexture}></meshStandardMaterial>
            </mesh>
            <mesh
              castShadow
              receiveShadow
              geometry={nodes['Collection|board_L_boardblend|Dupli|_board_0_2'].geometry}
          ...
          />
          <group
            position={[393.245, 93.868, -239.339]}
            rotation={[-Math.PI / 2, 0, -Math.PI]}
            scale={100}>
            <mesh
              castShadow
          ...
          <group
            position={[393.245, 93.868, 237.28]}
            rotation={[-Math.PI / 2, 0, -Math.PI]}
            scale={100}>
            <mesh
              castShadow
...
useGLTF.preload('/models/classroom_updated2.glb')